...
class CapabilityMapper:
    ...
    def _initialize_capability_definitions(self) -> Dict[str, List[ToolCapability]]:
        ...
        capabilities = {
            ...
            "mcp-server-git": [
                ToolCapability(
                    CapabilityCategory.DEVELOPMENT, "version_control",
                    "Git repository operations and version control",
                    ["git", "commit", "branch", "merge", "repository", "version"],
                    3
                ),
                ToolCapability(
                    CapabilityCategory.DEVELOPMENT, "code_history",
            ...
            "mcp-server-github": [
                ToolCapability(
                    CapabilityCategory.DEVELOPMENT, "repository_management",
                    "GitHub repository operations",
                    ["github", "repo", "issues", "pull", "release"],
                    3
                ),
                ToolCapability(
                    CapabilityCategory.COMMUNICATION, "collaboration",
            ...
            "filesystem": [
                ToolCapability(
                    CapabilityCategory.FILESYSTEM, "file_operations",
                    "File and directory operations",
                    ["file", "directory", "read", "write", "create", "delete"],
                    1
                ),
                ToolCapability(
                    CapabilityCategory.FILESYSTEM, "file_search",
            ...
            "mcp-server-fetch": [
                ToolCapability(
                    CapabilityCategory.NETWORK, "web_fetch",
            ...
            "brave-search": [
                ToolCapability(
                    CapabilityCategory.SEARCH, "web_search",
            ...
            "browsermcp": [
                ToolCapability(
                    CapabilityCategory.AUTOMATION, "browser_automation",
            ...
            "puppeteer": [
                ToolCapability(
                    CapabilityCategory.AUTOMATION, "web_automation",
            ...
            "mcp-server-sqlite": [
                ToolCapability(
                    CapabilityCategory.DATA, "database_sqlite",
            ...
            "mcp-server-postgres": [
                ToolCapability(
                    CapabilityCategory.DATA, "database_postgres",
            ...
            "sequential-thinking": [
                ToolCapability(
                    CapabilityCategory.COGNITIVE, "reasoning",
            ...
            "mcp-reasoner": [
                ToolCapability(
                    CapabilityCategory.COGNITIVE, "advanced_reasoning",
            ...
            "memory": [
                ToolCapability(
                    CapabilityCategory.DATA, "knowledge_graph",
            ...
            "taskmanager": [
                ToolCapability(
                    CapabilityCategory.AUTOMATION, "task_management",
            ...
            "github-project-manager": [
                ToolCapability(
                    CapabilityCategory.DEVELOPMENT, "project_management",
            ...
            "n8n-workflow-builder": [
                ToolCapability(
                    CapabilityCategory.AUTOMATION, "workflow_automation",
    ...
    def _initialize_task_keywords(self) -> Dict[str, List[str]]:
        ...
        return {
            ...
            "development:git": [
                ...
                "version control", "code history", "diff", "checkout"
            ],
            "development:github": [
                "github", "issues", "pull request", "repository", "release",
                "collaboration", "code review", "fork", "clone"
            ],
            "development:project_management": [
                "project", "milestone", "roadmap", "planning", "tracking",
            ...
            "search:web": [
                ...
                "query", "research", "information"
            ],
            
            # Data keywords
            "data:database": [
                "database", "sql", "query", "store", "retrieve", "persist",
                "table", "record", "data"
            ],
            "data:knowledge_graph": [
                "memory", "knowledge", "graph", "relationships", "entities",
                "connections", "recall", "remember"
            ],
            ...
            "filesystem:search": [
                "find file", "search file", "locate", "glob", "pattern match"
            ],
            
            # Automation keywords
            "automation:browser": [
                "browser", "navigate", "click", "interact", "automate",
                "screenshot", "scrape", "web automation"
            ],
            "automation:workflow": [
                "workflow", "automation", "trigger", "integration", "n8n",
                "process", "pipeline"
            ],
            "automation:task": [
                "task", "todo", "manage", "organize", "plan", "schedule"
            ],
            
            # Network keywords
            "network:fetch": [
                "fetch", "download", "url", "http", "web content", "get"
            ],
            
            # Cognitive keywords
            "cognitive:reasoning": [
                "analyze", "reason", "think", "problem solve", "decision",
                "logic", "strategy", "complex reasoning"
            ]
        }
    
    async def analyze_server_config(self, server_name: str, 
                                  server_config: Dict[str, Any]) -> List[ToolCapability]:
        """
    ...
    async def _analyze_complex_patterns(self, task_description: str) -> List[str]:
        ...
        if any(word in task_lower for word in ["website", "web page", "browser", "navigate"]):
            additional_capabilities.append("automation:browser")
        
        # Pattern: Planning/organizing
        if any(word in task_lower for word in ["plan", "organize", "schedule", "manage"]):
    ...
    async def suggest_tool_combinations(self, 
                                      required_capabilities: List[str]) -> List[Dict[str, Any]]:
        """
        ...
        suggestion = {
            ...
            'tools_needed': len(set(cap.split(':')[0] for cap in required_capabilities))
        }
    ...
    def _get_strategy_reasoning(self, strategy: str, complexity: int) -> str:
        ...
        return reasoning_map.get(strategy, f"Strategy selected based on complexity {complexity}")
