...
class TaskAnalyzer:
    ...
    def __init__(self):
        ...
        self.complexity_indicators = {
            ...
            TaskComplexity.COMPLEX: [
                'complex', 'detailed', 'comprehensive', 'thorough', 'analyze',
                'compare', 'evaluate'
            ],
    ...
    def analyze_task(self, task_description: str) -> TaskAnalysis:
        ...
        required_capabilities = {req.capability for req in requirements if not req.optional}
    ...
    def _extract_requirements(
        ...
        base_requirements = {
            ...
            TaskType.FILE_OPERATIONS: [
                TaskRequirement(ToolCategory.FILE_SYSTEM, 5)
            ],
            TaskType.WEB_AUTOMATION: [
            ...
            TaskType.COMMUNICATION: [
                TaskRequirement(ToolCategory.COMMUNICATION, 5)
            ],
            TaskType.REASONING: [
