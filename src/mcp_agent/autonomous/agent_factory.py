...
class DynamicAgentFactory:
    ...
    def _initialize_agent_templates(self) -> Dict[str, AgentTemplate]:
        ...
        templates = {
            ...
            "git_specialist": AgentTemplate(
                ...
                capabilities_focus=["development:version_control", "development:code_history"],
            ...
            "github_specialist": AgentTemplate(
                ...
                capabilities_focus=["development:repository_management", "communication:collaboration"],
            ...
            "workflow_architect": AgentTemplate(
                ...
                capabilities_focus=["automation:workflow_automation", "automation:task_management"],
            ...
            "browser_automator": AgentTemplate(
                ...
                capabilities_focus=["automation:browser_automation", "automation:web_automation"],
            ...
            "task_coordinator": AgentTemplate(
                ...
                capabilities_focus=["automation:task_management", "development:project_management"],
            ...
            "reasoning_expert": AgentTemplate(
                ...
                capabilities_focus=["cognitive:reasoning", "cognitive:advanced_reasoning"],
            ...
            "file_manager": AgentTemplate(
                ...
                capabilities_focus=["filesystem:file_operations", "filesystem:file_search"],
    ...
    async def create_agent(self, 
        ...
        self.logger.info(f"Created agent '{name}' with {len(available_servers)} servers")
        return agent
    
    async def create_swarm_agent(self,
                               name: str,
                               instruction: str,
                               server_names: List[str],
                               handoff_functions: Optional[List] = None) -> SwarmAgent:
        """
    ...
    async def create_specialized_agent(self, 
                                     ...
                                     available_tools: Optional[List[MCPToolInfo]] = None) -> Agent:
        """
        ...
        best_template = await self._find_best_template(capability_requirements, available_tools)
    ...
    async def create_agent_team(self, 
                              capability_requirements: List[str],
                              team_size: Optional[int] = None) -> List[Agent]:
        """
        ...
        capability_groups = self._group_capabilities_by_category(capability_requirements)
    ...
    async def _ensure_servers_available(self, server_names: List[str]) -> List[str]:
        ...
        for server_name in server_names:
            ...
            if server_name in self.discovery.discovered_tools:
                ...
                self.logger.warning(f"Server {server_name} not found in discovery registry")
        
        return available_servers
    
    async def _find_best_template(self, 
                                capability_requirements: List[str],
                                available_tools: List[MCPToolInfo]) -> AgentTemplate:
    ...
    def _score_template_match(self, 
                            template: AgentTemplate,
                            capability_requirements: List[str]) -> float:
    ...
    async def _find_tools_for_capabilities(self, 
    ...
    async def _customize_template(self, 
                                template: AgentTemplate,
                                capability_requirements: List[str],
                                required_tools: List[str]) -> AgentTemplate:
        ...
        customized = AgentTemplate(
            ...
            capabilities_focus=template.capabilities_focus.copy() if template.capabilities_focus else [],
            personality_traits=template.personality_traits.copy() if template.personality_traits else []
        )
        ...
        if capability_requirements:
            ...
            if cap_descriptions:
                customized.instruction += f" You specialize in: {', '.join(cap_descriptions)}."
    ...
    def _group_capabilities_by_category(self, 
    ...
    async def update_agent_performance(self, 
        ...
        self.logger.debug(f"Updated performance for agent {agent_key}: "
